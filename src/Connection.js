...
(function() {
  ...
  Connection = (function(superClass) {
    ...
    function Connection(arg) {
      var urls;
      this.retryDelay = arg.retryDelay, urls = arg.urls, this.maxRetry = arg.maxRetry, this.heartbeat = arg.heartbeat;
  ...
  Connection.getConnection = function(arg) {
    var heartbeat, maxRetry, retryDelay, urls;
    urls = arg.urls, retryDelay = arg.retryDelay, maxRetry = arg.maxRetry, heartbeat = arg.heartbeat;
    if (!connections[urls]) {
