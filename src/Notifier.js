...
(function() {
  ...
  Notifier = (function() {
    function Notifier(_arg) {
      this.url = _arg.url, this.prefix = _arg.prefix, this.topic = _arg.topic, this.exchange = _arg.exchange, this.delay = _arg.delay, this.noAck = _arg.noAck, this.queue = _arg.queue;
      if (this.delay == null) {
        this.delay = 1000;
      }
      if (this.queue == null) {
