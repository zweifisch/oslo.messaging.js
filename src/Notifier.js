...
(function() {
  ...
  Notifier = (function(superClass) {
    ...
    function Notifier(arg) {
      this.url = arg.url, this.prefix = arg.prefix, this.topic = arg.topic, this.exchange = arg.exchange, this.retryDelay = arg.retryDelay, this.noAck = arg.noAck, this.queue = arg.queue, this.maxRetry = arg.maxRetry, this.heartbeat = arg.heartbeat;
