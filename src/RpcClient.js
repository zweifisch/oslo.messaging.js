...
(function() {
  ...
  RpcClient = (function(superClass) {
    ...
    function RpcClient(arg) {
      this.url = arg.url, this.exchange = arg.exchange, this.topic = arg.topic, this.version = arg.version, this.timeout = arg.timeout, this.ttl = arg.ttl, this.noAck = arg.noAck, this.retryDelay = arg.retryDelay, this.messageTtl = arg.messageTtl, this.maxRetry = arg.maxRetry, this.connectionTimeout = arg.connectionTimeout;
      this.consumers = {};
      this.ttl || (this.ttl = 60000);
      this.retryDelay || (this.retryDelay = 3000);
      this.maxRetry || (this.maxRetry = 3);
      this.connectionTimeout || (this.connectionTimeout = 10);
