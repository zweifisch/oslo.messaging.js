...
(function() {
  ...
  RpcClient = (function(_super) {
    __extends(RpcClient, _super);

    function RpcClient(_arg) {
      this.url = _arg.url, this.exchange = _arg.exchange, this.topic = _arg.topic, this.version = _arg.version, this.timeout = _arg.timeout, this.ttl = _arg.ttl, this.noAck = _arg.noAck, this.retryDelay = _arg.retryDelay, this.messageTtl = _arg.messageTtl, this.maxRetry = _arg.maxRetry;
      this.consumers = {};
